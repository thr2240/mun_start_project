...
type MsgClaim struct {
	...
	ConditionType ConditionType `protobuf:"varint,3,opt,name=conditionType,proto3,enum=mun.claim.ConditionType" json:"conditionType,omitempty"`
}
...
func (m *MsgClaim) GetAirdropId() uint64 {
	if m != nil {
		return m.AirdropId
	}
	return 0
...
func (m *MsgClaim) GetConditionType() ConditionType {
	if m != nil {
		return m.ConditionType
	}
	return ConditionTypeUnspecified
}
...
func init() {
	proto.RegisterType((*MsgClaim)(nil), "mun.claim.MsgClaim")
	proto.RegisterType((*MsgClaimResponse)(nil), "mun.claim.MsgClaimResponse")
}
...
var fileDescriptor_5064b28f68e807c3 = []byte{
	...
	,
}
...
func (c *msgClient) Claim(ctx context.Context, in *MsgClaim, opts ...grpc.CallOption) (*MsgClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mun.claim.Msg/Claim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Claim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mun.claim.Msg/Claim",
	}
